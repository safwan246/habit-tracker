...
// If you have a Habit type with _id, you can use that instead of IHabit:
...
// if your Habit type extends IHabit with _id,
// you can do: type HabitWithId = Habit;
// here I'll just use IHabit – it still works for the callback
interface NavbarProps {
  userId: string;
  onHabitCreated?: (habit: IHabit) => void; // ✅ added, optional
}
...
export default function Navbar({ userId, onHabitCreated }: NavbarProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // ✅ safely call callback only if parent provided it
      if (onHabitCreated) {
