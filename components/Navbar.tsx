            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <input
                  name="title"
                  required
                  className="w-full rounded-xl border text-black border-neutral-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-orange-200 focus:border-transparent"
              ...
              <div className="space-y-1">
                ...
                <textarea
                  name="description"
                  rows={3}
                  className="w-full rounded-xl border text-black border-neutral-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-orange-200 focus:border-transparent resize-none"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    required
                    defaultValue=""
                    className="w-full rounded-xl border text-black border-neutral-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-orange-200 focus:border-transparent bg-white"
                  >
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    required
                    defaultValue=""
                    className="w-full rounded-xl text-black border border-neutral-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-orange-200 focus:border-transparent bg-white"
                  >
                    <option value="" disabled>
                      Select frequency
                    </option>
              ...
              <div className="space-y-1">
                ...
                <input
                  name="trigger"
                  className="w-full rounded-xl text-black border border-neutral-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-orange-200 focus:border-transparent"
